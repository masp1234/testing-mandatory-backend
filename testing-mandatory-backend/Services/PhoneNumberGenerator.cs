...
namespace testing_mandatory_backend.Services
{
    public class PhoneNumberGenerator : IPhoneNumberGenerator
    {
        ...
        // Method to generate a phone number without any prefix
        public string GeneratePhoneNumberWithoutPrefix()
        {
            // Generate a random phone number of standard length (e.g., 8 digits)
            return GenerateRandomDigits(PhoneNumberLength);
        }
